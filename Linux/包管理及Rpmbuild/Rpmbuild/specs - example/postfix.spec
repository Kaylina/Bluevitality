...
Patch1: postfix-2.11.0-alternatives.patch
Patch2: postfix-large-fs.patch
Patch3: postfix-vda-v13-2.10.0.patch

BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildRequires: pkgconfig, zlib-devel

%if 0%{?rhel} > 6
BuildRequires: libdb4-devel, libdb-devel
%else 
...
%changelog
* Mon Feb 03 2014 Ivan Polonevich <joni @ wargaming dot net> - 2:2.11.0-1
- Rebuild for WG. Disable Mysql,PostgreSQL,LDAP.

* Wed Jan 17 2014 Denis Frolov <d.frolov81@mail.ru> 2:2.11.0-1
- update to 2.11.0

* Wed Sep 25 2013 Denis Frolov <d.frolov81@mail.ru> 2:2.10.2-1
- update to 2.10.2

* Wed Feb 13 2013 Denis Frolov <d.frolov81@mail.ru> 2:2.10.0-1
- update to 2.10.0

* Fri Dec 14 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.9.5-1
- update to 2.9.5

* Fri Aug 17 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.9.4-1
- update to 2.9.4

* Tue May 24 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.9.3-1
- update to 2.9.3

* Thu May 10 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.9.2-1
- update to 2.9.2

* Fri Feb 24 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.9.1-1
- update to 2.9.1

* Wed Feb 01 2012 Denis Frolov <d.frolov81@mail.ru> 2:2.8.8-1
- update to 2.8.8

* Mon Nov 07 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.7-1
- update to 2.8.7

* Thu Oct 25 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.6-1
- update to 2.8.6
