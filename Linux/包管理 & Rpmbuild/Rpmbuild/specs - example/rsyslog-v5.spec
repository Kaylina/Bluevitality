...
#selinux ext
echo "/var/run/syslogd\.pid   --      system_u:object_r:syslogd_var_run_t:s0" >> /etc/selinux/targeted/contexts/files/file_contexts
echo "/var/run/syslogd\.pid   --      system_u:object_r:syslogd_var_run_t:s0" >> /etc/selinux/targeted/modules/active/file_contexts.template
echo "/var/run/syslogd\.pid   --      system_u:object_r:syslogd_var_run_t:s0" >> /etc/selinux/targeted/modules/active/file_contexts
...
%changelog
* Tue Aug 26 2014 Ivan Polonevich <joni @ wargaming dot net> - 5.10.0-5
- Revert change pid name

* Fri Feb 21 2014 Ivan Polonevich <joni @ wargaming dot net> - 5.10.0-3
- Change pid name to rsyslog.pid
