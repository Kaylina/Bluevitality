...
#%definedebug_package 		%{nil}

# Avoid CentOS 5/6 extras processes on contents (especially brp-java-repack-jars)
%define __os_install_post %{nil}

%define date_ver 20121016
%define ver 151320
%define git_ci 36564abc7e

Name: jmxtrans
Version: %{date_ver}.%{ver}.%{git_ci}
Release: 1
...
Source0: https://github.com/downloads/jmxtrans/jmxtrans/jmxtrans-%{date_ver}-%{ver}-%{git_ci}.zip
...
%prep
%setup -q -n jmxtrans-%{date_ver}-%{ver}-%{git_ci}
...
%changelog
* Fri May 02 2014 Ivan Polonevich <joni @ wargaming dot net> - 20121016.151320.36564abc7e-1
- Rebuild for WG
