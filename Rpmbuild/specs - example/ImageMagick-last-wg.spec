...
Source0:        http://www.imagemagick.org/download/ImageMagick/ImageMagick-%{VERSIONS}-%{Patchlevel}.tar.bz2
...
BuildRequires:  lcms-devel, libxml2-devel, OpenEXR-devel
#librsvg2-devel, libwmf-devel, ghostscript-devel, 
...
%prep
%setup -q -n ImageMagick-%{VERSIONS}-%{Patchlevel}
...
%{_libdir}/ImageMagick-%{VERSIONS}
%{_datadir}/ImageMagick-%{MAJOR_VERSION}
%exclude %{_libdir}/ImageMagick-%{VERSIONS}/modules-*/coders/djvu.*
...
%files djvu
%defattr(-,root,root,-)
%{_libdir}/ImageMagick-%{VERSIONS}/modules-Q*/coders/djvu.*
...
%{_bindir}/Magick++-config
%{_includedir}/ImageMagick-%{MAJOR_VERSION}/Magick++
%{_includedir}/ImageMagick-%{MAJOR_VERSION}/Magick++.h
%{_libdir}/libMagick++*so*
...
%changelog
* Sat Dec 28 2013 Ivan Polonevich <joni @ wargaming dot net> - 6.8.7-10.1
- Rebuild without X

* Tue Dec 24 2013 Ivan Polonevich <joni @ wargaming dot net> - 6.8.7-10
