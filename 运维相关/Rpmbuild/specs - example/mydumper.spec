...
BuildRequires:  glib2-devel, zlib-devel, pcre-devel, cmake, python-docutils

%if 0%{?rhel} == 6
BuildRequires:  python-sphinx10, mysql-devel
%endif

%if 0%{?rhel} > 6
BuildRequires:  python-sphinx, mysql-devel
%endif
...
%changelog
* Thu Sep 18 2014 Ivan Polonevich <joni @ wargaming dot net> - 0.6.2-1
- Update to 0.6.2 release

* Thu Apr 24 2014 Ivan Polonevich <joni @ wargaming dot net> - 0.6.1-1
- Rebuild for WG
